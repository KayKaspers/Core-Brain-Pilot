...
| **Implementierung erlaubt** | **nein** |
| **Stand** | **SPEZIFIKATION ERREICHT · SKELETON UND QUARANTÄNE-MVP LOKAL** — vier A0-Entscheidungen (D-034…D-037, [ADR-0009](../decisions/ADR-0009-technische-sicherheitsgrundlage.md)); KB-01…KB-12 abnehmbar spezifiziert. CBP-WP-012 hat einen **lokalen, fail-closed Runtime Skeleton** erstellt (`run` verweigert); CBP-WP-013 einen **lokalen, synthetisch testbaren Quarantäne-MVP** (D-038…D-041, [ADR-0010](../decisions/ADR-0010-ingest-quarantaene-mvp.md), keine Promotion); CBP-WP-014 einen **lokalen, deaktivierten Source-Registry-MVP** (D-042…D-045, [ADR-0011](../decisions/ADR-0011-deterministische-source-registry.md), 212 Tests, `activate` verweigert). **Keine KB-Kontrolle auf der Ziel-VM durchgesetzt**; alle `DOCUMENTED ONLY`, Readiness Gate `NOT EVALUATED`, R-32 offen |
