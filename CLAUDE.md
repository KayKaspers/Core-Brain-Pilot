...
| **Synthetic Evidence Contract 2.0 MVP** | **lokaler Prototyp** (CBP-WP-017, D-051, `committed` `d3168c4`) — synthetic-only, read-only, nicht persistent, fail-closed; Evidence-Schema **2.0** mit eingebetteten strukturierten Artefakten, Provenance-/Binding-Hashes, deterministische **Invalid-/Stale-/Conflict-Erkennung** (ohne Uhr), **negative-evidence-only** (keine positive Gate-Erfüllung); Schema 1.0 fail-closed; kein RT-2, keine Persistenz, keine Aktivierung; **451 Tests**, **nicht produktiv** |
