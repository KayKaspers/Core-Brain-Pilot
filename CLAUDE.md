...
| Aktuelles Work Package | **CBP-WP-021** (`in-review`, **Phase B1/B2 – Coordinated Reconciliation and Validation**) — **D-056**, `ADR_NOT_REQUIRED`; kanonisches Security-Foundation-Testinventar: **32 Negativtests** (NT-01…NT-24, NT-26…NT-33) · **1 Positivtest** (PT-01) · **33 Testfälle**; **0 von 32** und **0 von 1** ausgeführt. B0 `committed` (`0cb4ea9`); **B1/B2 implementiert und validiert, uncommitted**. Zuletzt abgeschlossen **CBP-WP-020** (`committed`, `complete`; **D-055**; Zielzustand **Z1 erreicht**, Scope **S2 abgeschlossen**, RT-2-Grenze **P1 eingehalten**; B0 `17057e2`, B1/B2 `9c6c0fb`, C `d6a1a3c`). **CBP-WP-022 ist nicht registriert und nicht autorisiert** |
