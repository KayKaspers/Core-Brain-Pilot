...
| Aktuelles Work Package | **CBP-WP-020** (`in-review`, **Phase B0 – Registration and Additive Deployment-Root Authority**) — **D-055**, `ADR_NOT_REQUIRED`; Zielzustand **Z1**, Scope **S2**, RT-2-Grenze **P1**; `deployments/profile-a/` als **späterer B1-Pfad autorisiert, nicht angelegt**; **B3 (reale Bereitstellung) ausgeschlossen**; zuletzt abgeschlossen **CBP-WP-019** (`committed` `3c437f2`); **uncommitted, Commit-Autorität beim Human Maintainer** |
