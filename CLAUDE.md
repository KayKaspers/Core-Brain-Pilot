...
| Aktuelles Work Package | **CBP-WP-021** (`in-review`, **Phase B0 – Registration and Canonical Authority**) — **D-056**, `ADR_NOT_REQUIRED`; stellt das kanonische Security-Foundation-Testinventar fest: **32 Negativtests** (NT-01…NT-24, NT-26…NT-33) · **1 Positivtest** (PT-01) · **33 Testfälle**; **0 von 32** und **0 von 1** ausgeführt; **uncommitted**. Zuletzt abgeschlossen **CBP-WP-020** (`committed`, `complete`; **D-055**; Zielzustand **Z1 erreicht**, Scope **S2 abgeschlossen**, RT-2-Grenze **P1 eingehalten**; B0 `17057e2`, B1/B2 `9c6c0fb`, C `d6a1a3c`). **CBP-WP-022 ist nicht registriert und nicht autorisiert** |
| **Kanonisches Security-Testinventar** | **32 Negativtests · 1 Positivtest · 33 Testfälle** (D-056, A2-Acceptance-Matrix). **NT-25 ist nicht aktiv** — der Fall ist als **PT-01** klassifiziert, die Nummer bleibt nach Regel **TT-5** bewusst frei. **NT-32 und NT-33 sind gültig** und lösen die frühere Doppelvergabe von NT-23/NT-24 auf; die Matrix-Fälle NT-23 und NT-24 bleiben unverändert aktiv. **Die Zahl 31 ist ein überholter, falsch etikettierter Ableitungswert.** **Ausgeführt: 0 von 32 Negativtests, 0 von 1 Positivtest** — die Feststellung eines Inventarwerts ist **keine** Testausführung. **Übergangsabweichung:** einige committete Dokumente und die ausführbaren Profil-A-Artefakte führen bis zur B1/B2-Korrektur weiterhin **31** |
...
| Entscheidungen | **56** getroffen, davon **52** mit A0 |
