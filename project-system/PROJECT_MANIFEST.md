...
| Aktuelles Work Package | **CBP-WP-021** (`in-review`, **Phase B1/B2 – Coordinated Reconciliation and Validation**) — **D-056**, `ADR_NOT_REQUIRED`; kanonisches Security-Testinventar **32 / 1 / 33**, **0 ausgeführt**; B0 `committed` (`0cb4ea9`), **B1/B2 uncommitted**. Zuletzt abgeschlossen **CBP-WP-020** (`committed`, `complete`; **D-055**; **Z1 erreicht / S2 abgeschlossen / P1 eingehalten**; B0 `17057e2`, B1/B2 `9c6c0fb`, C `d6a1a3c`). **CBP-WP-022 nicht registriert, nicht autorisiert** |
