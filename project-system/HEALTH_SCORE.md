...
| Letzte Bewertung | 2026-08-03, im Rahmen von **CBP-WP-021** (`committed`, `complete`, Phase C, D-056) |
| Autoritätsklasse | A2 |
...
| Getroffene Entscheidungen | 14 | **56** |
| davon A0 | 8 | **52** |
...
| Vorgeschlagene Work Packages | 0 | **0** — **CBP-WP-021 `committed` und `complete`** (D-056; B0 `0cb4ea9`, B1/B2 `271acc7`); **kein Work Package aktiv**; **CBP-WP-020 `committed` und `complete`** (D-055; B0 `17057e2`, B1/B2 `9c6c0fb`, C `d6a1a3c`); CBP-WP-019 `committed` (`3c437f2`, D-054); **CBP-WP-022 nicht registriert, nicht autorisiert** |
