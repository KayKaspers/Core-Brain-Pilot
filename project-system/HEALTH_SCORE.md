...
| Letzte Bewertung | 2026-07-28, im Rahmen von **CBP-WP-017** |
| Autoritätsklasse | A2 |
...
| Entscheidungslage | **gut** | ↑ | **51 Entscheidungen, 12 angenommene ADRs**; G0, OD-26, Mappingkonvention, Sicherheitsgrundlage, Quarantäne-, Registry-, Mapping-Draft-Validator-, Gate-Evaluator- (D-050) und Evidence-Contract-2.0-MVP (D-051) entschieden |
...
| Kennzahl | CBP-WP-002 | **CBP-WP-017** |
| --- | --- | --- |
...
| Getroffene Entscheidungen | 14 | **51** |
| davon A0 | 8 | **47** |
...
| Vorgeschlagene Work Packages | 0 | **0** — CBP-WP-017 ist `in-review` (implementiert, D-051); CBP-WP-016 `committed` (`04c427c`) |
