...
| Neu in CBP-WP-022 | **1 konsolidierte A0-Entscheidung** (D-057 Registrierung CBP-WP-022 — KB-04 Enforcement Stage 1: A–M), **0 ADR** (`ADR_NOT_REQUIRED` **nur für die Registration**), 0 neue offene Entscheidungen, **keine neue Risiko-ID**; **keine Implementierungsfreigabe** — B1 und B2 nicht autorisiert |
