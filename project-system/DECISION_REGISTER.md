...
| Neu in CBP-WP-022 | **2 konsolidierte A0-Entscheidungen** — **D-057** (Registrierung, A–M; `ADR_NOT_REQUIRED` **nur für die Registration**) und **D-058** (ADR-Gate, A–M; Ergebnis **`ADR_REQUIRED`**, ADR-0014 vorgesehen und **nicht angelegt**); **0 ADR**, 0 neue offene Entscheidungen, **keine neue Risiko-ID**; **keine Implementierungsfreigabe** — B1B und B2 nicht autorisiert |
