...
| Aktuelles Work Package | **CBP-WP-022** (`in-review`, Phase B1A – Contract Boundary and ADR Gate) — **D-057** Registrierung, **D-058** ADR-Gate mit Ergebnis **`ADR_REQUIRED`** (ADR-0014 vorgesehen, **nicht angelegt**); B0 `committed` `e4caa14`; **KB-04 Enforcement Stage 1**, technische Implementierung **nicht autorisiert**. Zuvor abgeschlossen **CBP-WP-021** (`committed`, `complete`, 2026-08-03; **D-056**, `ADR_NOT_REQUIRED`; B0 `0cb4ea9`, B1/B2 `271acc7`); zuvor abgeschlossen **CBP-WP-020** (`committed`, `complete`; **D-055**; B0 `17057e2`, B1/B2 `9c6c0fb`, C `d6a1a3c`) |
